# UniNavi_NFC(QR) 기반 실시간 캠퍼스 정보 안내
...
**UniNavi**는 'University(대학교)'의 **Uni**와 'Navigation(길 안내)'의 **Navi**를 합성한 이름으로, 
> 학생들이 마치 **'대학교 전용 네비게이션'**을 이용하듯 캠퍼스 정보를 쉽고 빠르게 탐색할 수 있도록 설계된 실시간 캠퍼스 정보 안내 웹 서비스

강의실의 위치 및 실시간 사용 현황부터 교내 행정·학사 정보까지, 파편화된 정보들을 통합적으로 제공하여 **학생, 교직원, 방문객** 모두의 캠퍼스 생활 편의성을 증대
...
이러한 정보를 알아보려면 일일이 **학교 홈페이지를 찾아보거나 직접 건물을 돌아다녀야** 한다.
...
#### 상세 정보 제공
- 강의실 클릭 시 수업 시간, 교과목명, 담당 교수명, 수업 현황을 카드 형태로 표시
