...
<div align="center">
  <strong>대학교 전용 네비게이션 - 캠퍼스 정보를 쉽고 빠르게 탐색하는 NFC(QR) 기반 실시간 캠퍼스 정보 안내 웹 서비스</strong>
</div>
...
학생들이 대학교 전용 네비게이션을 이용하듯 캠퍼스 정보를 쉽고 빠르게 탐색할 수 있도록 설계된 실시간 캠퍼스 정보 안내 웹 서비스입니다.
...
-> 일일이 **학교 홈페이지를 찾아보거나 직접 건물을 돌아다녀야** 한다.
