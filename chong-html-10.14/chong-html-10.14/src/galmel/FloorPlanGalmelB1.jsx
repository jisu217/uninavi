...
const ROOMS = [
  ...
  { id: "AI융합설계실", label: "AI융합설계실", style: { top: 155, left: 290, width: 80, height: 100 } },

  { id: "AI융합이노베이션실", label: <>AI융합<br />이노베이션실</>, style: { top: 155, left: 490, width: 80, height: 100 } },
];
  ...
  return (
    <div className="building-floorplan-scroll">
      <div className="building-floorplan-canvas" style={{ width: CANVAS.width, height: CANVAS.height }}>
        ...
        <div className="building-room" style={{ top: "155px", left: "190px", width: "80px", height: "100px" }}>
          도서관서가
        </div>

        <div className="building-room" style={{ top: "155px", left: "390px", width: "80px", height: "100px" }}>
          교양정보<br />실습실
        </div>
