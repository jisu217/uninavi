  ...
  return (
    <div className="building-floorplan-scroll">
      ...
      >
        ...
        <div
          className="building-room clickable"
          style={{ top: "40px", left: "220px", width: "80px", height: "230px", fontSize: "13px" }}
          onClick={() => window.open("https://linktr.ee/With41_?fbclid=PAdGRleANXZ2dleHRuA2FlbQIxMQABp2j6N-XVmq0jHgx7h573GTKFtvXVOj3D5Mt2_-09UJA9FBZ3b0RWv3YvqbQr_aem_Xhv3D_6t-RDSdn2mVwqhSA", "_blank")}
        >
          총학생회실
        </div>
